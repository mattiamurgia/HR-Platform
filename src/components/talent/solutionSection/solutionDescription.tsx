...
const SolutionDescription = () => {
  return (
    <div className="w-full min-[992px]:p-8 min-[992px]:w-6/12 md:sticky md:top-20 mb-10 px-5">
      <h5 className="mb-3 text-sm font-medium text-second-green">
        WORKTECH SOLUTION
      </h5>
      <h1 className="font-semibold text-5xl text-second-green md:text-5xl md:leading-[80px] leading-[60px] mb-3">
        Soluzioni per il lavoro individuale e l'autonomia
      </h1>
      <p className="mb-5 text-xl leading-7 md:w-3/4 text-second-green">
